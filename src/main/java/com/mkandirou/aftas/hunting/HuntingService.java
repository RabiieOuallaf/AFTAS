...
public class HuntingService implements IHunting{
    ...
    public HuntingService(HuntingRepository huntingRepository, FishRepository fishRepository, App_UserRepository memberRepository, CompetitionRepository competitionRepository, ModelMapper modelMapper) {
    ...
    public HuntingDTOres save(HuntingDTOreq DTOreq) {
        ...
        if(existHunting!=null){
            ...
            App_user member = memberRepository.findById(DTOreq.getMember_id())
